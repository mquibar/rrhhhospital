...
import controllers.ctrlAltaAsignacionHorario;
import controllers.ctrlAltaRegistroPeriodo;
...
public class ServletModificarRegistroPeriodo extends HttpServlet {
    ...
    public ServletModificarRegistroPeriodo()
    {
    ...
    String guardar(HttpServletRequest request)
    {
        ...
        String fechaSalida = getValue(request, "fechaEntrada");//iguales
