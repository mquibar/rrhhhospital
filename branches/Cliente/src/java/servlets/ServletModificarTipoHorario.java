...
import controllers.ctrlModificarTipoHorario;
 ...
 */
public class ServletModificarTipoHorario extends HttpServlet {
   
    private ctrlModificarTipoHorario _control;
    private enum operaciones {LOADTH,MODIFICAR,ELIMINAR,GUARDAR}

    public ServletModificarTipoHorario()
    {
        _control = new ctrlModificarTipoHorario();
    }
