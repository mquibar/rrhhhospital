function validarCamposProfesional ()
{
    ...
    if(!tieneDatos(valorFromId("matricula")))
    {
        listaErrores += "La Persona debe tener Matricula. \n";
    }
    ...
    if(!tieneDatos(valorFromId("titulo")))
    {
        listaErrores += "La Persona debe tener titulo. \n";
    }
