...
public interface ExpConsultarDomicilio {
    ...
    public Entidades.Domicilio consultaDomicilioporId(int id);

    public java.util.List<Entidades.Localidad> consultarLocalidadesProvincia(Entidades.Provincia provincia);
